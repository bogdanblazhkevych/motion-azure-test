...
function globalSVG() {
        return(
                ...
                <svg viewBox="0 0 500 500">
                        ...
                        <path id="personglobe_1" data-name="personglobe 1" d="M250,16.6S16.945,16.6,16.945,249.657,250,482.712,250,482.712s233.055,0,233.055-233.055S250,16.6,250,16.6Zm0,31.205s-46.216,0-46.216,46.216S250,140.239,250,140.239s46.216,0,46.216-46.216S250,47.807,250,47.807ZM159.872,223.69s90.128-144.416,180.256,0"/>
                        <path id="globhelines_1" data-name="globhelines 1" d="M16.247,249.662H483.753m-366.5,0s0,129.863,129.863,233.753M374.091,249.662s2.886,129.863-126.977,233.753m0-233.753V483.415"/>
                </svg>
                </div>
        )
}
