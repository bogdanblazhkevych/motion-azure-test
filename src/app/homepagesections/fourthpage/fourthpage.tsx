...
function chipBrainSVG() {
    return(
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 1000 500">
                    ...
                    <path id="brainwire1_1" data-name="brainwire1 1" d="M532.748,170.781s-13.36-1.9-13.36,11.795c0,11.867,11.8,11.752,11.8,11.752s11.542-1.69,11.8-11.752C543.312,170.521,532.748,170.781,532.748,170.781Zm-26.641,33.1h13.281l8.115-10.283M467,200.2a15.864,15.864,0,0,0,16.97,8.08"/>
                    <path id="brainwire2_1" data-name="brainwire2 1" d="M565.981,198.177s-12.566-1.927-12.566,11.743c0,11.842,11.8,11.727,11.8,11.727s11.318-1.694,11.795-11.727C577.562,198.2,565.981,198.177,565.981,198.177Zm-59.008,29.334h39.808l9.583-8.8M448,235.573s15.314,3.417,25.8-8.8m-11.8,8.062a21.813,21.813,0,0,1,5.9,21.256"/>
                    <path id="brainwire3_1" data-name="brainwire3 1" d="M578.725,239.131s-13.072-2.619-13.193,12.717c-0.1,12.11,11.714,11.993,11.714,11.993s11.245-1.733,11.714-11.993C589.513,239.741,578.725,239.131,578.725,239.131Zm-71.761,12.717h58.568"/>
                    <path id="brainwire4_1" data-name="brainwire4 1" d="M565.609,282.4s-12.561-2.142-12.561,12.332c0,11.782,11.791,11.668,11.791,11.668s11.529-1.679,11.791-11.668C576.945,282.762,565.609,282.4,565.609,282.4Zm-58.989-5.9h39.795l9.581,8.75"/>
                    <path id="brainwire5_1" data-name="brainwire5 1" d="M532.59,309.954s-12.723-1.878-12.578,12.6c0.12,11.97,11.838,11.855,11.838,11.855s11.2-1.6,11.164-11.751c-0.046-12.934-10.424-12.7-10.424-12.7m-25.9-11.855h11.838l8.879,12.6M466,295.135s5.8-9.256,19.977-7.409"/>
            </svg>
    )
}
...
function connectednessSVG() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 1000 500">
            ...
            <path id="Line_1" data-name="Line 1" d="M143.646,202.354l0.708-.708,142,142-0.708.708Z"/>
            <path id="person1" d="M140,57.668s-72,0-72,72,72,72,72,72,72,0,72-72S140,57.668,140,57.668Zm0,16.619s-27.69,0-27.69,27.69S140,129.668,140,129.668s27.69,0,27.69-27.69S140,74.288,140,74.288ZM86,179.668s54-86.527,108,0"/>
            <path id="person2_1" data-name="person2 1" d="M860,299.387s-72,0-72,72,72,72,72,72,72,0,72-72S860,299.387,860,299.387Zm0,13.619s-27.69,0-27.69,27.691S860,368.387,860,368.387s27.69,0,27.69-27.69S860,313.006,860,313.006ZM806,418.387s54-86.527,108,0"/>
            <path id="Line_4" data-name="Line 4" d="M644.687,125.39l0.626-.78,219,174-0.626.78Z"/>
            <path id="Line_2" data-name="Line 2" d="M212,126v-1H500v1H212Z"/>
            <path id="Line_3" data-name="Line 3" d="M425.336,342.37l-0.672-.74,151-137,0.672,0.74Z"/>
        </svg>
    )
}
...
function graphSVG() {
    return(
        ...
        <path id="paththreeeee_1" data-name="paththreeeee 1" d="M72,390l72-138,216,36L504,162l198,54L864,108"/>
