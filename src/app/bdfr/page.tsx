...
export default function BDFR() {
    const listing = {
        "jobTitle": "Business Development & Strategic Partnerships Manager - France & EU",
        ...
        "aboutTheRole": "As a Business Development Manager you will work with the CTO and Chief Growth/Product Officer to prospect and qualify new businesses as well as manage clients through the Business Development process. We are looking for a motivated strategic business development leader to establish a solid footprint and successful growth of Motion in the French and European markets. This is a great opportunity to be part of the next great venture-backed start-up to thrive and to grow into a VP role within our company.",
        "jobResponsibilities": [
            ...
            "Works closely with product development as they have a great perspective on what’s happening in the market. Business Development can be valuable in recommending /evaluating potential new business/product/service line",
        ...
        "qualifications": {
            "required": [
                "Passion for new technologies, artificial intelligence, data analytics and deep knowledge of cloud computing, SaaS, DaaS in the French and the European Union markets​",
                ...
                "Excellent knowledge and first-hand experience and relationship with key stakeholders in the French Tech Ecosystem and ideally knowledge in other EU tech ecosystems",
                ...
                "Willingness to travel 40%-75% ( domestically in France, the EU, and occasionally some international travel included)",
