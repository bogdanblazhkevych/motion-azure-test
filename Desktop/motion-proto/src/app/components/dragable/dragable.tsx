...
export default function Dragable({ children }: DragablePropsInterface) {
    ...
    const [finalMouseCoordinates, setFinalMouseCoordinates] = useState<{ x: number, y: number }>({ x: 0, y: 0 });
    ...
    const handleDrag = (e: React.DragEvent) => {
        ...
        console.log(window.getComputedStyle(targetNode).getPropertyValue('transform'))
